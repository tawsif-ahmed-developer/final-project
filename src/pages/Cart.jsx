...
import { allproduct, decrementQuantity, incrementQuantity, removeCart } from '../components/slice/productSlice'
            ...
            <Container>
                <section className="bg-white py-8 antialiased dark:bg-white md:py-16">
                    <div className="mx-auto max-w-screen-xl px-4 2xl:px-0">
                        <h2 className="text-xl font-semibold text-gray-900 dark:text-[#262626] sm:text-2xl">
                            Shopping Cart
                        </h2>
                        <div className=" mt-6 sm:mt-8 md:gap-6 lg:flex lg:items-start xl:gap-8">
                            <div className="mx-auto w-full flex-none lg:max-w-2xl xl:max-w-4xl">
                                            ...
                                            <div className="rounded-lg border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-700 dark:bg-gray-800 md:p-6">
                                                <div className="space-y-4 md:flex md:items-center md:justify-between md:gap-6 md:space-y-0">
                                                    ...
                                                    <div className="flex items-center justify-between md:order-3 md:justify-end">
                                                        <div className="flex items-center">
                                                            <button
                                                                ...
                                                                className="px-2 text-red-500 py-1 border rounded"
                                                            >
                                                                -
                                                            </button>
                                                            <input
                                                    ...
                                                    <div className="w-full min-w-0 flex-1 space-y-4 md:order-2 md:max-w-md">
                                                        <div
                                                            href="#"
                                                            className="mb-5 text-base font-medium text-gray-900 hover:underline dark:text-white"
                                                        >
                                                            {item.title}
                                                        </div>
                                ...
                                <div className="hidden xl:mt-8 xl:block">
                                    <h3 className="text-2xl font-semibold text-gray-900 dark:text-[#262626]">
                                        People also bought
                                    </h3>
